...
function Ad_addChef() {
  ...
  const postProduct = async (e) => {
    e.preventDefault();
    const { product_id, product_name, product_price, category, stock, image } =
      setProduct;
  ...
  return (
    <div className="max-w-md h-auto mx-auto bg-black border-white border-[2px] mt-[3vh] p-6 rounded-2xl shadow-lg">
      <h2 className="text-xl font-bold mb-4 text-center">Add Chef info</h2>
