...
function Card1() {
  return (
    <div data-aos="fade-right" data-aos-duration="1000" data-aos-once="true" className='w-[70vw] shadow-xl h-[90vh] font-[poppins] md:flex gap-16 px-6 justify-center items-center rounded-xl'>
        <div className='bg-ser-1 rounded-xl w-[40vw] bg-cover h-[50vh]'></div>
        <div className='w-[60vw] h-[50vh] flex flex-col  gap-10 justify-center items-center'>
            <h1 className='text-4xl font-semibold'>Your Personal Chef Awaits</h1>
