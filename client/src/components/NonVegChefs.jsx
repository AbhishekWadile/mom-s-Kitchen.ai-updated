...
function NonVegChefs() {
  ...
  const navg =(index) =>{
    navigate(`/invitechef/nonvegchefinfo/:${chefs[index]._id}/:${chefs[index].Chef_id}`)
  }
  const settings = {
    dots: false,
    infinite: true,
            ...
            <div key={index} >
              <div className="w-[80%] mt-5 rounded-3xl h-auto shadow-lg flex justify-center items-center p-3">
                <div className="flex gap-3 flex-col justify-center items-center">
                  <img src={item.Chef_img} alt="" className="rounded-xl h-[50vh]" />
